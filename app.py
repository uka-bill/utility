...
def initialize_database_tables():
    ...
    try:
        ...
        tables = ['financial_years', 'schools', 'departments', 'utility_bills']
        for table in tables:
            try:
    ...
    try:
        ...
        if data.get('entity_type') == 'school':
            ...
            if school_response.data and len(school_response.data) > 0:
                ...
                water_account = school.get('water_account', '')
                water_meter = school.get('water_meter', '')
                electricity_account = school.get('electricity_account', '')
                electricity_meter = school.get('electricity_meter', '')
                telephone_account = school.get('telephone_account', '')
                telephone_number = school.get('telephone_number', '')
        elif data.get('entity_type') == 'department':
            dept_response = supabase.table("departments").select("*").eq("id", data.get('entity_id')).execute()
            if dept_response.data and len(dept_response.data) > 0:
                dept = dept_response.data[0]
                entity_name = dept.get('name', '')
                water_account = dept.get('water_account', '')
                water_meter = dept.get('water_meter', '')
                electricity_account = dept.get('electricity_account', '')
                electricity_meter = dept.get('electricity_meter', '')
                telephone_account = dept.get('telephone_account', '')
                telephone_number = dept.get('telephone_number', '')
        ...
        # If account number not provided, use the one from the entity
        if not account_number:
            if data.get('utility_type') == 'water' and water_account:
                account_number = water_account
                meter_number = water_meter if not meter_number else meter_number
            elif data.get('utility_type') == 'electricity' and electricity_account:
                account_number = electricity_account
                meter_number = electricity_meter if not meter_number else meter_number
            elif data.get('utility_type') == 'telephone' and telephone_account:
                account_number = telephone_account
                phone_number = telephone_number if not phone_number else phone_number
    ...
    try:
        ...
        if entity_type == 'school':
            ...
            if response.data and len(response.data) > 0:
                school = response.data[0]
                if utility_type == 'water' and school.get('water_account'):
                    accounts = [school.get('water_account')]
                elif utility_type == 'electricity' and school.get('electricity_account'):
                    accounts = [school.get('electricity_account')]
                elif utility_type == 'telephone' and school.get('telephone_account'):
                    accounts = [school.get('telephone_account')]
            ...
            if response.data and len(response.data) > 0:
                ...
                if utility_type == 'water' and dept.get('water_account'):
                    accounts = [dept.get('water_account')]
                elif utility_type == 'electricity' and dept.get('electricity_account'):
                    accounts = [dept.get('electricity_account')]
                elif utility_type == 'telephone' and dept.get('telephone_account'):
                    accounts = [dept.get('telephone_account')]
